Subject to these Terms of Service (this "Agreement"), [mailto.live](/) ("Inbox Zero", "we", "us" and/or "our") provides access to Inbox Zero's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
Inbox Zero provides an email management tool ("the Product"). The Product is accessible at mailto.live and other domains and subdomains controlled by Us (collectively, "the Website").
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at support@mailto.live.
