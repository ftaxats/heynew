...
export const metadata: Metadata = {
  ...
  description:
    "Decluttering your inbox has never been easier, or looked as organized as you want! Why? When we buy items or join an online service, the company adds us to an email subscription list, and we soon receive quite a few and all will pile up in our inbox. This article will help you fix that mess and teach you how to bulk unsubscribe from emails using Mailto Live, a tool with the best features that can automatically unsubscribe from emails, and more. Let's make your life easier and more productive!",
  alternates: {
