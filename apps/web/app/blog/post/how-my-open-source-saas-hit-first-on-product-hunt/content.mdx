export const metadata = {
  ...
  description: "Mailto Live finished first place on Product Hunt. This is how we did it.",
  date: "2024-01-22",
  author: "Akshat Shah"
}

# How Mailto Live hit \#1 on Product Hunt

Two weeks ago I launched Mailto Live on Product Hunt. It finished in first place with over 1,000 upvotes and gained thousands of new users.
...
[Mailto Live](https://mailto.live) helps you clean up your inbox fast. It lets you bulk unsubscribe from newsletters, automate emails with an AI assistant, automatically block cold emails, and provides email analytics.

I also run a YouTube channel for devs called [Learn from Open Source](https://ftaxatshahchanel.com/mailto_live).
...
Being open source also means anyone can contribute to the project to improve it or fix bugs. Mailto Live already has developers from all over the world contributing to making it better. Top open source projects have hundreds of contributers.
...
Another common concern people have is whether the company will lose revenue to self-hosters. Instead of paying $10 per month to use Mailto Live, you could clone the project for free and self-host. Which would hurt Mailto Live's revenue.

It’s especially bad if you have an expensive product. To save the $10-19 per month fee that Mailto Live charges for the pro version, it might not be worth the effort to self-host. The time it will take you to set it up, and then run the servers yourself, you’re better off paying the monthly subscription. Not to mention 99% of people can’t self-host. You’d need a developer to do it.
...
It did for Mailto Live.

![Mailto Live Growth](/images/blog/inbox-zero-growth.png)

The launch led to Mailto Live being featured in popular newsletters such as Ben’s Bites and The Rundown AI. Newsletters that are read by hundreds of thousands of people.
...
This is the Product Hunt page for Mailto Live for reference as I talk about some of the things I did: [https://www.producthunt.com/products/inbox-zero-2](https://www.producthunt.com/products/inbox-zero-2)

I’ve also created a video that goes into more detail here:

[https://www.ftaxatshahchanel.com/watch?v=bJT4fjLNWOA&](https://www.ftaxatshahchanel.com/watch?v=bJT4fjLNWOA&)
...
Product Hunt has said you no longer need a hunter. But I made sure to have one. The Product Hunt team doesn't feature every product that launches on the homepage. So I felt adding a hunter would give me a better chance of the PH team selecting Mailto Live to be featured. It also adds some legitimacy to the launch.
...
What I'd recommend here is to create a simple slideshow. I created mine on Figma but you can use any tool. Watch [this video](https://www.ftaxatshahchanel.com/watch?v=bJT4fjLNWOA&) to see exactly how I did this.
...
If you enjoyed this article, be sure to try [Mailto Live](https://mailto.live) to automate your email and clean up your inbox.

You can follow me on Twitter at: [mailto_live](https://twitter.com/mailto_live).

And subscribe to my YouTube channel, [Learn from Open Source](https://ftaxatshahchanel.com/mailto_live).
